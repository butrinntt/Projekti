  ...
  <div class="user_input_box1">
    <div class="box-content">
      ...
      <form action="" method="post">
        ...
        <button class="button" id="log-button" onclick="window.location.href='login.php'">
          Login
        </button>
      </form>
      <p>Your child isn't in our kindergarten yet? Sign them up now!</p>
      <button class="button" id="register-button" onclick="window.location.href='register.php'">
        Sign up
      </button>
    </div>
  </div>
